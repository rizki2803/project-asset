<form id="form-in" class="form-horizontal" method="post" action="" onsubmit="submitbtn.disabled=true; return true;">
    @csrf
    ...
    <div class="modal-body clearfix">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="form-line">
                    <input type="text" value="" class="form-control" name="asst" id="asst" placeholder="Masukkan No Asset (optional)" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-body clearfix">
        <div class="col-sm-8">
            <div class="form-group">
                <label>Penerima Kedatangan Barang</label>
                <div class="form-line">
