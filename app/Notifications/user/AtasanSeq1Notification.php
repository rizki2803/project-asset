...
class AtasanSeq1Notification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $urlApprove = route('user.pengajuanBarang.atasan.seq1.approve', ['kode_reg' => $this->data['p_reg'], 'p_token' => $this->data['p_token']]);
